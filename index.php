...
<head>
    ...
    <style>
        ...
        form {
            background: rgba(187, 135, 247, 0.66);
            box-shadow: 0 8px 32px 0 rgba(1, 3, 14, 0.54);
            backdrop-filter: blur(8px);
            -webkit-backdrop-filter: blur(8px);
            border-radius: 18px;
            border: 1px solid rgb(93, 10, 247);
        ...
        .btn-registrar:hover {
            ...
            box-shadow: 0 4px 16px rgba(255, 126, 95, 0.13);
        }
...
<body>
    <main>
        <article>
            <section>
                <form action="controlador/inicio_sesion.php" method="POST">
                    <h1>Inicia Sesión</h1>
